...
resource "Ad_Units" do
  ...
  let!(:ad_unit_params) do
    {
      ...
      click_url_android: ad_unit.click_url_android,
      click_url_ios: ad_unit.click_url_ios,
  ...
  get "/ad_units/default" do
    ...
    parameter :ad_unit_url, "Advertisement URL", :scope => :ad_unit
    ...
    parameter :click_url_android, "Android mobile deep link", :scope => :ad_unit
    parameter :click_url_ios, "iOS mobile deep link", :scope => :ad_unit
    parameter :call_to_action, "Call to action engagement", :scope => :ad_unit
