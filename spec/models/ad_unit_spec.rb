...
describe AdUnit, type: :model do
  ...
  describe "#fetch" do
    it "should return a valid ad unit" do
      ad_unit = AdUnit.fetch(format: AdUnit::FORMAT_IMAGE, dimensions: AdUnit::DIMENSIONS_16_BY_9)
    ...
    it "should not return an ad unit without corresponding format or dimension" do
      ad_unit = AdUnit.fetch(format: AdUnit::FORMAT_IMAGE, dimensions: AdUnit::DIMENSIONS_1_BY_1)

      expect(ad_unit).to be_nil
    end

    it "should fetch all corresponding ad unit entries" do
      ad_units = AdUnit.fetch_all(format: AdUnit::FORMAT_IMAGE, dimensions: AdUnit::DIMENSIONS_16_BY_9)
